// collatz_funcs.c: functions to compute elements of a Collatz
// sequence.
...
// than 1, return -1. If n is equal to 1, return 0 as the sequence has
...
// value at each step.  Returns the number of steps to converge, 15 in
